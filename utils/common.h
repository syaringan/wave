...
typedef enum result{
    ...
    CHAINE_TOO_LONG = 52,
    FOUND = 53,
    INCONSISITENT_CERTIFICATE_HOLDER_TYPE = 54,
    INVALID_PERMISSION_TYPE = 55,
    INCONSISITENT_PERMISSIONS = 56,
    INCORRECT_CA_CERTIFICATE_TYPE = 57,
    NON_REVOCABLE_NON_EXPIRING_CERTIFICATE = 58,
    INCONSISTENT_EXPIRY_TIMES = 59,
    INCONSISTENT_START_TIMES = 60,
    START_VALIDITY_LATER_THAN_EXPIRATION = 61,
    TOO_MANY_ENTRIES_IN_RECTANGULAR_GEOGRAPHIC_SCOPE = 62,
}result;
