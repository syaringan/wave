...
//////////////  other_permissions ????
    bitnum2=head_bit_num(mbuf);
	  root_ca_scope->flags_content.other_permissions.len=variablelength_data_num(mbuf,bitnum2);
	   if(size<root_ca_scope->name.len*sizeof(u8)+bitnum2)
		   return -1;
	   mbuf+=bitnum2;
	   size+=bitnum2;
...
//queshao can shu
    ...
    bitnum=head_bit_num(mbuf);
	  tobesigned_certificate_request->flags_content.other_cert.len=variablelength_data_num(mbuf,bitnum);
	   if( tobesigned_certificate_request->flags_content.other_cert .len*sizeof(u8)+bitnum)
		   return -1;
	   mbuf+=bitnum;
	   size+=bitnum;
	   ...
	   fill_buf8(  tobesigned_certificate_request->flags_content.other_cert.buf,mbuf,  tobesigned_certificate_request->flags_content.other_cert.len);
